...
pageSlider.on("transitionEnd", function () {
  let indexSlide = pageSlider.realIndex;
	if (indexSlide > 1) {
		footerLink.classList.add('_active')
  } else{
	  footerLink.classList.remove("_active");
  }
});
const footerLink = document.querySelector(".footer__link");
footerLink.addEventListener("click", function(e) {
	pageSlider.slideToLoop(0, 800);
});
...
const comandsSlider = new Swiper(".slider-comands", {
  // Количество слайдов для показа
  ...
  // элементов слайда
  navigation: {
    nextEl: ".screen-comands__next",
    prevEl: ".screen-comands__prev",
  },

  pagination: {
    el: ".screen-comands__pagination",
    type: "fraction",
    // Кастомный вывод фракции
    renderFraction: function (currentClass, totalClass) {
      return (
